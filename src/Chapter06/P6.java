...
public class P6 {
     ...
     * Conversion Method
     *
     * @param dollars current amount of money given
     * @param exchangeRate extra payment for having more than 100 dollars
     * @return the dollars that have gone through the payment reduction
     */
